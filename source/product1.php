...
?>
	...
	?>	
        <tr>
          ...
          <td align="center"><a href="eqSelect.php?Product_Id=<?=$row["Product_Id"]?>"><img src="image/shopping.png" width="24" height="24" border="0" /></a></td>
        </tr>
	<?php
	}?>
...
echo "<script>alert('ไม่พบข้อมูลที่ต้องการค้นหา')</script>";
	...
	?>	
        <tr>
          ...
          <td align="center"><a href="eqSelect.php?Product_Id=<?=$row["Product_Id"]?>"><img src="image/ed.png" width="24" height="24" border="0" /></a></td>
