...
?>
	...
	?>	
        <tr>
          ...
          <td align="center"><img src="img_view.php?Product_Id=<?php echo $row["Product_Id"];?>"></td>
...
echo "<script>alert('ไม่พบข้อมูลที่ต้องการค้นหา')</script>";
	...
	?>	
        <tr>
          ...
          <td align="center"><a href="page_order.php?Product_Id=<?=$row["Product_Id"]?>"><img src="image/ed.png" width="24" height="24" border="0" /></a></td>
