...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" height="260" border="0" align="center" cellpadding="0" cellspacing="0" id="details1">		
		<tr>
<td colspan="2" height = "40" bgcolor="#64B5F6"><div align="center"><strong><font size = "5">แบบฟอร์มเพิ่มข้อมูลผู้ใช้งาน</font></strong></div></td>			  
        </tr> 	
      <tr>
        <td>
	<?php
...
<form name="frm" action="save_mrg_user.php" method="post" onSubmit="return chkForm();">
<br />
