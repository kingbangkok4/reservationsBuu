		...
		<tr>
			...
			<td width="80%" valign="top">
				<table width="900" border="0" align="center" cellpadding="0"
					cellspacing="0" bordercolor="#FF3333" id="details1">
					<tr height="50">
						<td colspan="8" height="40" bgcolor="#FF3333"><div align="center">
								<strong><font size="5">จัดการข้อมูลเจ้าหน้าที่</font></strong>
							</div></td>
					</tr>
					...
					<form method="post" action="">
						<table width="900" border="0" align="center" cellpadding="0"
							...
							<tr bgcolor="#FF3333">
								<td valign="top" bgcolor="#FF3333" align="">&nbsp;ค้นหาชื่อ-สกุล
									(จากบางคำ):</td>
								<td align="center" width=""><input type="text" name="idper"
									id="idper" /></td>
								<td align="left">
									<button type="submit" name="search" id="button">
										<img src="image/5search.png" title="ปุ่มค้นหาชื่อลบุคลากร " />
									</button>
								</td>

								<td valign="top" bgcolor="#FF3333" align="right">เพิ่มข้อมูลบุคลากร
									:&nbsp;</td>
								<td align="left" valign="top" bgcolor="#FF3333"><a
									href="add_mrg_staff.php"><button type="button" name="button"
											id="button">
											<img src="image/9add.png" title="ปุ่มเพิ่มข้อมูลบุคลากร" />
										</button></td>
							</tr>
					...
					<form method="post" action="">
						<table width="900" border="1" bordercolor="#FF3333" align="center"
							...
							<tr>
								...
								<td width="" bgcolor="#FF6633"><div align="center">ชื่อ -
										นามสกุล</div></td>
...
if ($idper == "") {
	...
	while ( $row = mysql_fetch_array ( $result ) ) {
        ...
        <tr>
								...
								<td align="center"><a
									href="edit_mrg.php?Person_Id=<?=$row["Person_Id"]?>"><img
										src="image/3edit.png" width="24" height="24" border="0" /></a></td>
								<td align="center"><a
									href="edit_mrg_password.php?Person_Id=<?=$row["Person_Id"]?>"><img
										src="image/3edit.png" width="24" height="24" border="0" /></a></td>
								<td align="center"><a
									href="delete_mrg.php?Person_Id=<?=$row["Person_Id"]?>"
									onclick="return confirm ('ยืนยันการลบข้อมูลบุคลากร') "><img
										src="image/4del.png" width="24" height="24" border="0" /></a></td>
							</tr>
	<?php
	}
	?>
...
<?
	...
	while ( $row = mysql_fetch_array ( $result ) ) {
        ...
        <tr>
								...
								<td align="center"><a
									href="edit_mrg.php?Person_Id=<?=$row["Person_Id"]?>&Search_Key=<?=$idper?>"><img
										src="image/3edit.png" width="24" height="24" border="0" /></a></td>
								<td align="center"><a
									href="edit_mrg_password.php?Person_Id=<?=$row["Person_Id"]?>&Search_Key=<?=$idper?>"><img
										src="image/3edit.png" width="24" height="24" border="0" /></a></td>
								<td align="center"><a
									href="delete_mrg.php?Person_Id=<?=$row["Person_Id"]?>"
									onclick="return confirm ('ยืนยันการลบข้อมูลบุคลากร') "><img
