...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#4DB6AC" id="details1">		
		<tr height="50">
<td colspan="8" height = "40" bgcolor="#4DB6AC"><div align="center"><strong><font size = "5">รายงานการสั่งจองสินค้า</font></strong></div></td>			  
        </tr> 
...
<table width="100%" border="1" bordercolor="#4DB6AC" align="center" cellpadding="0" cellspacing="0" >
  ...
  <?php
		...
		$strSQL = "SELECT orders_detail.* , product.* FROM orders_detail, product WHERE orders_detail.Product_Code = product.Product_Code and orders_detail.type = 'Reserve'";
...
<br />
<input name="" id="" type="button" onClick="javascript:window.location.href='report_reserve.php';" value="พิมพ์รายงาน" />
</form>		  
