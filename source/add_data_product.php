...
function chkForm(){
	...
	<table width="750" height="260" border="0" align="center" cellpadding="0" cellspacing="0" id="details1">		
		<tr>
<td colspan="2" height = "40" bgcolor="#FF6666"><div align="center"><strong><font size = "5">แบบฟอร์มเพิ่มข้อมูลสินค้า</font></strong></div></td>			  
        </tr> 	
      <tr>
        <td>
	<?php
...
//echo "ID : <input type='text' name ='Product_Id'><br>";
echo "รหัสสินค้า  : <input type='text' name ='Product_Code'><br>";
echo "ชื่อข้อมูลสินค้า  : <input type='text' name ='Product_Name'><br>";
echo "ราคา  : <input type='text' name ='Product_Price'><br>";
echo "จำนวนสินค้าคงเหลือ  : <input type='text' name ='Product_Stock'><br>";
echo "รูปภาพ  : <input type='file' name ='Product_picture'accept='image/*'><br>";
//echo "วันเดือนปีเกิด : ";
